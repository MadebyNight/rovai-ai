...
pub const SESSION_CHARTER_REVISION: i64 = 6;
pub const CODEX_SESSION_GUIDANCE_REVISION: i64 = 1;
pub const AGENT_RUN_CONTEXT_FORMATTER_VERSION: i64 = 24;
pub const CONTEXT_MANIFEST_VERSION: i64 = 24;
...
mod tests {
    ...
    fn shared_fixture() -> Value {
        serde_json::from_str(include_str!(
            "../../../packages/contracts/fixtures/agent-run-context-v24.json"
        ))
    ...
    fn binding_contract_freezes_each_context_axis_version() {
        ...
        assert_eq!(current["sessionCharterRevision"], 6);
        assert_eq!(
            current,
            json!({
                "nativeSessionBootstrap": fixture["nativeSessionBootstrap"],
