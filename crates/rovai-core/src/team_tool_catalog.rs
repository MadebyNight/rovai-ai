...
pub fn builtin_tool_definitions() -> Vec<Value> {
    vec![
        json!({"name":"mission.get","title":"Read the current Mission","description":"Read the current Camp's Mission.","inputSchema":{"type":"object","additionalProperties":false,"properties":{}},"outputSchema":{"type":"object","additionalProperties":false,"required":["missionId","title","description","status","sourceMessageId"],"properties":{"missionId":{"type":"string"},"title":{"type":"string"},"description":{"type":"string"},"status":{"type":"string","enum":["needs_you","not_started","in_progress","completed"]},"sourceMessageId":{"type":["string","null"]}}}}),
