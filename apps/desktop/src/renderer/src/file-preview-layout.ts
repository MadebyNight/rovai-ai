...
export function filePreviewSplitMinWidth(_activityMode = false): number {
  return FILE_PREVIEW_SPLIT_MIN_WIDTH
}

export function filePreviewCloseThreshold(_activityMode = false): number {
