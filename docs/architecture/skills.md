...
Skills 是模型可按需读取的文件指南，不改变工具、权限、消息路由或协作资格。当前版本的字段和版本轴见 [Skills Rebuild v1](../contracts/skills-rebuild-v1.md) 与 [ContextManifest v30](../contracts/context-manifest-evidence-v30.md)；旧 Library 和项目投递的恢复边界见 [历史 Skill Projection](skill-projection-reconciliation.md)。
