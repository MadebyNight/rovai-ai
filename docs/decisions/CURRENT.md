...
- 正文块与维护写放大当前规范：[Evidence 持久化与模型观察边界](../contracts/run-process-detail-surface-v33.md#evidence-持久化与模型观察边界)、[Camp Open](../contracts/camp-open-projection-v18.md)、[可见来源确认](../contracts/notification-episode-v6.md)、[Evidence 不变量](../architecture/foundational-invariants.md#evidence-usage)；理由：[V1.53-D02](../versions/v1.53/decisions.md#v1-53-d02)。
...
- 当前规范：[File Preview Architecture](../architecture/file-preview.md)、[File Preview v12](../contracts/file-preview-v12.md)、[Camp 文件预览区](../ui/components/file-preview.md)及[Camp 会话工作区](../ui/components/conversation-workspace.md)。
...
- 当前规范：[Channel Storage v3](../contracts/channel-storage-v3.md)、[飞书渠道架构](../architecture/feishu-channel.md)、[Feishu Channel v16](../contracts/feishu-channel-v16.md)、[钉钉渠道架构](../architecture/dingtalk-channel.md)、[DingTalk Channel v13](../contracts/dingtalk-channel-v13.md)、[Camp Membership v2](../contracts/camp-membership-v2.md)、[ContextManifest Evidence v23](../contracts/context-manifest-evidence-v23.md)和[渠道设置](../ui/components/channel-settings.md)。
...
- 当前规范：[Single Chat Architecture](../architecture/single-chat.md)、[Single Chat v5](../contracts/single-chat-v5.md)、[AgentRun Recovery](../architecture/agent-run-recovery.md)和[Camp 内单聊 UI](../ui/components/conversation-workspace.md#camp-内单聊)。
...
- 当前退出前先保存 active Composer Draft、失败不启动 Planned Shutdown 的理由：[V1.49-D01](../versions/v1.49/decisions.md#v1-49-d01)。
...
- 当前规范：[Context 基础不变量](../architecture/foundational-invariants.md#context-session-bootstrap)、[Native Session Bootstrap Redelivery](../architecture/native-session-bootstrap-redelivery.md)、[Structured Skill Links](../architecture/structured-current-input-skill-links.md)、[ContextManifest Evidence v23](../contracts/context-manifest-evidence-v23.md)、[Context Delivery Profile v5](../contracts/context-delivery-profile-v5.md)、[Run Facts v2](../contracts/run-facts-v2.md)和[Current Input Skill Links v1](../contracts/current-input-skill-links-v1.md)。
...
- 当前规范：[Skill/MCP 基础不变量](../architecture/foundational-invariants.md#skills-builtin-transport)、[Built-in Tool Runtime](../architecture/builtin-tool-runtime.md)、[Skill Projection](../architecture/skill-projection-reconciliation.md)、[Built-in Tool Transport v24](../contracts/builtin-tool-transport-v24.md)、[Windows Skill Projection v1](../contracts/windows-skill-projection-v1.md)、[Skill Content Preview v1](../contracts/skill-content-preview-v1.md)和[Capability settings](../ui/components/capability-settings.md)。
...
- 当前规范：[Scheduled Automation 不变量](../architecture/foundational-invariants.md#scheduled-automation)、[Scheduled Automation Architecture](../architecture/scheduled-automation.md)、[Scheduled Automation v1](../contracts/scheduled-automation-v1.md)、[Automation 工作区](../ui/components/automation-workspace.md)和[Built-in Tool Transport v24](../contracts/builtin-tool-transport-v24.md)。
...
- Pi terminal assistant model-call Usage、原生 Action lifecycle 与 `agent_start` admission 的当前字段边界由 [Runtime Launch v41](../contracts/runtime-launch-and-verification-v41.md)继承并收敛，接入理由见 [V1.39-D01](../versions/v1.39/decisions.md#v1-39-d01)和[V1.48-D01](../versions/v1.48/decisions.md#v1-48-d01)。
...
- 当前规范：[Camp Attachment v9](../contracts/camp-attachment-v9.md)、[Camp Message Send v19](../contracts/camp-message-send-v19.md)、[Built-in Tool Transport v24](../contracts/builtin-tool-transport-v24.md)及[附件架构](../architecture/camp-published-attachment-view.md)。Agent CLI 的私有 snapshot 语义继续由 v7 条款拥有，不受 Desktop Source Ref v9 替换影响。
- 主要理由：[V1.32-D01](../versions/v1.32/decisions.md#v1-32-d01)：由 CLI 以 Runtime 权限适配外部路径，保持 Core 的读取根目录限制。

## Camp 连续消息

- 当前规范：[Pending Camp Input v4](../contracts/pending-camp-input-v4.md)、[Camp Composer Draft v13](../contracts/camp-composer-draft-v13.md)、[Composer 架构](../architecture/camp-composer-draft.md)。
- 私有准入、单编辑占用和显式恢复的理由：[V1.33-D01](../versions/v1.33/decisions.md#v1-33-d01)；source refs、排队附件与 Runtime 适配理由：[V1.40-D01](../versions/v1.40/decisions.md#v1-40-d01)；V2 content 与低频 flush 理由：[V1.43-D01](../versions/v1.43/decisions.md#v1-43-d01)、[V1.43-D02](../versions/v1.43/decisions.md#v1-43-d02)；唯一 Draft authority、inline Decorator Atom 与统一有界 Trigger 理由：[V1.45-D01](../versions/v1.45/decisions.md#v1-45-d01)、[V1.45-D02](../versions/v1.45/decisions.md#v1-45-d02)、[V1.45-D03](../versions/v1.45/decisions.md#v1-45-d03)；同步交互锁、Core content 显式回写与加载 fail-closed 理由：[V1.46-D01](../versions/v1.46/decisions.md#v1-46-d01)；统一 active-Camp 导航离开边界理由：[V1.47-D01](../versions/v1.47/decisions.md#v1-47-d01)；App 退出前复用同一 guard 的理由：[V1.49-D01](../versions/v1.49/decisions.md#v1-49-d01)。

- [V1.56-D01](../versions/v1.56/decisions.md#v1-56-d01)：选文快照独立于 Reply 与派发。

## 取消事务与 Runtime 清理

- 当前规范：[Cancellation Settlement v2](../contracts/cancellation-settlement-v2.md)、[Accepted Input Recovery v5](../contracts/accepted-input-recovery-v5.md)、[Camp Membership v2](../contracts/camp-membership-v2.md)、[Channel Storage v3](../contracts/channel-storage-v3.md)和[Runtime 恢复与关闭](../architecture/foundational-invariants.md#runtime-recovery-shutdown)。
- 理由：[V1.37-D02](../versions/v1.37/decisions.md#v1-37-d02)。


## 官方 ZCode 接入

- 当前规范：[Runtime Catalog](../architecture/runtime-catalog-boundaries.md#官方-zcode-当前边界)、[Runtime Launch v41](../contracts/runtime-launch-and-verification-v41.md)、[Runtime Platform Admission v2](../contracts/runtime-platform-admission-v2.md)、[File Change v5](../contracts/runtime-file-change-observation-v5.md)。
...
- 当前规范：[统一 Rust Host](../architecture/unified-rust-host.md)、[Host Lifecycle v1](../contracts/host-lifecycle-v1.md)、[Host Web v2](../contracts/host-web-v2.md)与[Server 开发预览](../development/server-preview.md)。
