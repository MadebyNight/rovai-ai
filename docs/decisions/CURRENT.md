...
当前 Skills 来源与模型冻结的取舍见 [V1.70-D01](../versions/v1.70/decisions.md#v1-70-d01) 和 [V1.70-D02](../versions/v1.70/decisions.md#v1-70-d02)；旧项目入口改为显式清理的理由见 [V1.70-D03](../versions/v1.70/decisions.md#v1-70-d03)，Windows 固定官方名称的清理准入见 [V1.70-D04](../versions/v1.70/decisions.md#v1-70-d04)。旧 Library/项目投递仅作为历史恢复与用户显式处理的证据。
