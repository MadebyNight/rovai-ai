...
- Web HTML 附件预览：[统一 Host 的用户文件](../architecture/unified-rust-host.md#草稿与用户文件)、[Host Web v2](../contracts/host-web-v2.md)、[文件查看器](../ui/components/file-preview.md)；可信同来源与原生存储取舍见 [V1.59-D08](../versions/v1.59/decisions.md#v1-59-d08)，初始方案见 [V1.59-D04](../versions/v1.59/decisions.md#v1-59-d04)。
