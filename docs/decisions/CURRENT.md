...
- 当前规范：[File Preview Architecture](../architecture/file-preview.md)、[File Preview v14](../contracts/file-preview-v14.md)、[Camp 文件预览区](../ui/components/file-preview.md)及[Camp 会话工作区](../ui/components/conversation-workspace.md)。
...
- 当前规范：[Mission 架构](../architecture/missions.md)、[Mission v1](../contracts/mission-v1.md)、[使命板 UI](../ui/components/mission-board.md)、[ContextManifest v24](../contracts/context-manifest-evidence-v24.md)及 [`CONTEXT.md`](../../CONTEXT.md)。
- 复用 Camp、preparing 才创建持久工作区、固定基准与无模型业务版本的理由：[V1.59-D08](../versions/v1.59/decisions.md#v1-59-d08)。
...
- 当前规范：[Context 基础不变量](../architecture/foundational-invariants.md#context-session-bootstrap)、[Native Session Bootstrap Redelivery](../architecture/native-session-bootstrap-redelivery.md)、[Structured Skill Links](../architecture/structured-current-input-skill-links.md)、[ContextManifest Evidence v24](../contracts/context-manifest-evidence-v24.md)、[Context Delivery Profile v6](../contracts/context-delivery-profile-v6.md)、[Run Facts v3](../contracts/run-facts-v3.md)和[Current Input Skill Links v1](../contracts/current-input-skill-links-v1.md)。
...
- 当前规范：[Skill/MCP 基础不变量](../architecture/foundational-invariants.md#skills-builtin-transport)、[Built-in Tool Runtime](../architecture/builtin-tool-runtime.md)、[Skill Projection](../architecture/skill-projection-reconciliation.md)、[Built-in Tool Transport v25](../contracts/builtin-tool-transport-v25.md)、[Windows Skill Projection v1](../contracts/windows-skill-projection-v1.md)、[Skill Content Preview v1](../contracts/skill-content-preview-v1.md)和[Capability settings](../ui/components/capability-settings.md)。
...
- 当前规范：[Scheduled Automation 不变量](../architecture/foundational-invariants.md#scheduled-automation)、[Scheduled Automation Architecture](../architecture/scheduled-automation.md)、[Scheduled Automation v1](../contracts/scheduled-automation-v1.md)、[Automation 工作区](../ui/components/automation-workspace.md)和[Built-in Tool Transport v25](../contracts/builtin-tool-transport-v25.md)。
...
- 当前规范：[Camp Attachment v9](../contracts/camp-attachment-v9.md)、[Camp Message Send v19](../contracts/camp-message-send-v19.md)、[Built-in Tool Transport v25](../contracts/builtin-tool-transport-v25.md)及[附件架构](../architecture/camp-published-attachment-view.md)。Agent CLI 的私有 snapshot 语义继续由 v7 条款拥有，不受 Desktop Source Ref v9 替换影响。
