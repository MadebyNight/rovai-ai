...
| [首次训练与“初次集结”](first-run-onboarding.md) | Full Core ready 后的三页 mandatory gate、Runtime/模型选择、断点恢复与真实 Quick Chat 的 Desktop-local starter |
...
| [应用内提醒与会话未读](notification-center.md) | 暂时隐藏持久中心后的轻量 heads-up、Camp 未读点、exact AgentRun/CampTurn/消息可见确认与错误恢复 |
