...
| 层级 | 权威入口 |
| --- | --- |
| public Composer 本地所有权、发送快照、失败保留与退出边界 | [Camp Composer Draft v14](../../contracts/camp-composer-draft-v14.md)与[Pending Camp Activation v2](../../contracts/pending-camp-activation-v2.md) |
