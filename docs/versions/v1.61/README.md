...
[完成判断确认说明 revision 1](model-context-change-mission-completion.md)，实施与验证见
...
| Contracts | 已更新 | 发布 [Mission v5](../../contracts/mission-v5.md)、[Built-in Tool Transport v29](../../contracts/builtin-tool-transport-v29.md)与[Single Chat v6](../../contracts/single-chat-v6.md)；ContextManifest v26 记录 Mission-only Charter revision 10 |
