...
| 修改 Composer Skill Picker 的结构化身份、claim-time 批次资格、`RUN_INPUT.messages[].skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Skills Rebuild v1](contracts/skills-rebuild-v1.md)、[Run Input Skill Links v2](contracts/current-input-skill-links-v2.md)、[ContextManifest Evidence v31](contracts/context-manifest-evidence-v31.md)、[Skills 架构](architecture/skills.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
