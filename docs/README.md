...
| 任务 | 必读资料 |
|---|---|
| 修改 Mission、使命工作区、累计 Git Diff、使命上下文或桌面使命板 | [使命架构](architecture/missions.md)、[Mission v11](contracts/mission-v11.md)、[ContextManifest v30](contracts/context-manifest-evidence-v30.md)及[使命板 UI](ui/components/mission-board.md) |
...
| 修改 Domain Command Gateway、`command.result` 持久回放、事件 payload/订阅、`event_log` 回执存储或幂等结果 | [Domain Command Result v1](contracts/domain-command-result-v1.md)、[Core 事务与 Read Side 不变量](architecture/foundational-invariants.md#core-command-transaction)、[Availability-first Runtime](architecture/availability-first-runtime.md)及[v1.53 实施计划](versions/v1.53/implementation-plan.md) |
...
| 修改 public Camp 输入框、发送失败保留、撤回、附件 source refs 或 Desktop-local 编辑状态 | [Camp Composer Draft v15](contracts/camp-composer-draft-v15.md)、[Public Camp Composer 架构](architecture/camp-composer-draft.md)、[Camp Message Send v23](contracts/camp-message-send-v23.md)、[结构化 Mention 与 Atom](ui/components/structured-mentions.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Camp 内单聊、私有 Conversation、Single Chat Context/Built-in policy、私有 terminal 路由、结束/取消、Conversation 级待发送队列或单聊 UI | [Single Chat v8](contracts/single-chat-v8.md)、[Single Chat Architecture](architecture/single-chat.md)、[Camp Attachment v10](contracts/camp-attachment-v10.md)、[Camp 会话工作区](ui/components/conversation-workspace.md#camp-内单聊) |
...
| 修改 Camp 动态添加/移除队员、至少一位成员、Default Lead 替换、membership generation/version、离队 cutover/reconciliation、外部 roster 同步或成员管理 UI | [Camp Membership v2](contracts/camp-membership-v2.md)、[动态 Camp 队员关系](architecture/dynamic-camp-membership.md)、[成员生命周期不变量](architecture/foundational-invariants.md#member-lifecycle)、[协作与执行准入不变量](architecture/foundational-invariants.md#collaboration-admission)、[Camp Open Projection v23](contracts/camp-open-projection-v23.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改飞书或钉钉渠道、渠道 credential/Developer Session 存储、队员 Bot、Owner identity、OAuth、Quick Chat/Project Catalog、PendingCampBinding、渠道会话、ExternalPrincipal、多 Bot、ChannelTurnRequest、群 roster、执行控制台、永久输出/附件、卡片/Outbox 或渠道设置 UI | 先读 [Channel Message Bridge v1](contracts/channel-message-bridge-v1.md)与[Channel Storage v3](contracts/channel-storage-v3.md)，再按 Provider 读取 [Feishu Channel v16](contracts/feishu-channel-v16.md)与[飞书渠道架构](architecture/feishu-channel.md)，或 [DingTalk Channel v13](contracts/dingtalk-channel-v13.md)与[钉钉渠道架构](architecture/dingtalk-channel.md)；共享边界继续读[Camp Membership v2](contracts/camp-membership-v2.md)、[Camp Attachment v10](contracts/camp-attachment-v10.md)、[ContextManifest Evidence v30](contracts/context-manifest-evidence-v30.md)及[渠道设置](ui/components/channel-settings.md) |
...
| 修改内置 Agent CLI、IPC、Envelope、receipt、完整结果运输、Single Chat history、定时 Automation、Mission、队员创建、Agent Send 或幂等合同 | [Built-in Tool Transport v32](contracts/builtin-tool-transport-v32.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v23](contracts/camp-message-send-v23.md)及[Current User Attention v7](contracts/current-user-attention-v7.md) |
...
| 修改 `camp.search`、`camp.read`、`history.search`、公共读取范围、实时可见性、recipient suppression、撤回过滤、Camp message publication fence 或 Agent read 附件输出 | [Camp History v9](contracts/camp-history-v9.md)、[公共上下文不变量](architecture/foundational-invariants.md#context-public-history)、[History 与寻址不变量](architecture/foundational-invariants.md#collaboration-history-addressing)、[Message Delivery 不变量](architecture/foundational-invariants.md#collaboration-delivery)、[Built-in Tool Runtime](architecture/builtin-tool-runtime.md)及[Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md) |
...
| 修改通知来源、Episode 聚合、未读/清除、会话可见确认、增量、浮层设置或类型化导航 | [Notification Episode v8](contracts/notification-episode-v8.md)、[Current User Attention v7](contracts/current-user-attention-v7.md)、[通知事实与投影](architecture/foundational-invariants.md#core-notifications)及[Notification Episode 架构](architecture/notification-episodes.md) |
| 修改 Desktop 用户 source attachment、Agent 原路径引用与历史 Managed v2、legacy Draft/Published 授权、Composer/Pending/Agent ingress、Timeline 系统打开、按动作 availability、Runtime resolver/root 或模型附件路径 | [Camp Attachment v10](contracts/camp-attachment-v10.md)、[Camp Published Attachment View v4（legacy）](contracts/camp-published-attachment-view-v4.md)、[Camp Attachments 架构](architecture/camp-published-attachment-view.md)、[ContextManifest Evidence v25](contracts/context-manifest-evidence-v25.md)、[Camp History Retrieval v6](contracts/camp-history-v6.md)、[Camp Identity v1](contracts/camp-identity-v1.md)、[Camp 资源不变量](architecture/foundational-invariants.md#camp-resources)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[会话区拖放 UI](ui/components/conversation-drop-zone.md) |
| 修改用户消息回复、接收者选择、Composer Text + Atom/Typeahead/Clipboard、Renderer 当前输入、发送失败保留、离开 Camp/退出提醒、纯附件发送或失效换人 | [Composer 不变量](architecture/foundational-invariants.md#camp-composer)、[Camp Composer v14](contracts/camp-composer-draft-v14.md)、[Camp Composer 架构](architecture/camp-composer-draft.md)、[结构化 Mention 与 Atom](ui/components/structured-mentions.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Camp 打开、冷启动恢复壳层、投影/存在性检查、会话历史分页、运行中 Evidence、membership reconciliation、AgentRun 文件变化、high-water/cache 或首屏性能日志 | [Camp Open Projection v23](contracts/camp-open-projection-v23.md)、[Camp Open Read Path](architecture/camp-open-read-path.md)、[Core 受管内容不变量](architecture/foundational-invariants.md#core-managed-content)、[协作与执行准入不变量](architecture/foundational-invariants.md#collaboration-admission)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Desktop Navigation Snapshot、Sidecar Project 顺序/冻结/同步、侧栏 Run marker、Core 失效通知、全局刷新协调、失败退避、前后台刷新或安全轮询 | [Desktop Navigation Refresh](architecture/desktop-navigation-refresh.md)、[Core Snapshot 不变量](architecture/foundational-invariants.md#core-read-side)、[产品与导航不变量](architecture/foundational-invariants.md#product-navigation)及[App Shell 与统一侧栏](ui/components/app-shell-navigation.md) |
| 修改 Desktop 启动壳层、Full Core Supervisor、data-dir lease、SQLite authority 准入/迁移、generation fencing、bootstrap diagnostics 或 Core request failure transport | [Desktop 可用性与权威准入不变量](architecture/foundational-invariants.md#desktop-authority-admission)、[Availability-first Runtime](architecture/availability-first-runtime.md)、[Desktop Runtime Availability v2](contracts/desktop-runtime-availability-v2.md)及[Bootstrap Shell](ui/components/bootstrap-shell.md) |
...
| 修改 Camp 永久删除、异步受理、删除准入 fence、删除后的 Runtime 收敛或受管资源清理 | [Camp Permanent Deletion v4](contracts/camp-permanent-deletion-v4.md)、[Camp 永久删除架构](architecture/camp-deletion.md)、[Camp Published Attachment View](architecture/camp-published-attachment-view.md)、[Camp 资源不变量](architecture/foundational-invariants.md#camp-resources)、[协作与执行准入不变量](architecture/foundational-invariants.md#collaboration-admission)、[Runtime 恢复与关闭不变量](architecture/foundational-invariants.md#runtime-recovery-shutdown)及[Runtime 进程与校验不变量](architecture/foundational-invariants.md#runtime-process-verification) |
| 修改首次安装判断、新手训练页、无 Runtime 延后配置、断点恢复、首次队员/Runtime provisioning、`初次集结` 或 starter 输入行为 | [First-run Onboarding v5](contracts/first-run-onboarding-v5.md)、[First-run Onboarding 架构](architecture/first-run-onboarding.md)、[Availability-first Runtime](architecture/availability-first-runtime.md)、[首次训练 UI](ui/components/first-run-onboarding.md)、[Camp 生命周期不变量](architecture/foundational-invariants.md#camp-lifecycle)、[Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)及[Camp Composer Draft v15](contracts/camp-composer-draft-v15.md) |
...
| 修改当前 Skills 受管文件、队员工具箱、Harness 原生发现、旧项目投影清理或设置页 | [Skills 架构](architecture/skills.md)、[Skills Rebuild v1](contracts/skills-rebuild-v1.md)、[Skills UI](ui/components/skills-settings.md)及[Runtime 进程与校验不变量](architecture/foundational-invariants.md#runtime-process-verification)；旧 Revision/投影恢复再读[历史 Skill Projection](architecture/skill-projection-reconciliation.md) |
| 修改 Composer Skill Picker 的结构化身份、claim-time 批次资格、`RUN_INPUT.messages[].skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Skills Rebuild v1](contracts/skills-rebuild-v1.md)、[ContextManifest Evidence v30](contracts/context-manifest-evidence-v30.md)、[Skills 架构](architecture/skills.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 Task 状态、字段、可见性、权限、列表、CampMember 收口、self-active awareness 或 linked execution 准入 | [Durable Task v5](contracts/durable-task-v5.md)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)及[Durable Task 不变量](architecture/foundational-invariants.md#collaboration-task) |
| 修改 waiting Delivery、目标 Conversation 路由、FIFO batch claim、多输入 AgentRun、input budget、accepted 增量窗口或投递 Profile | [Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md)、[Message Delivery v10](contracts/message-delivery-v10.md)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v10](contracts/context-delivery-profile-v10.md)及[ContextManifest v30](contracts/context-manifest-evidence-v30.md) |
| 修改 Native Session Bootstrap、AgentRun Dynamic Context、`RUN_INPUT`、增量公共窗口、模型可见字段/JSON、遗漏、ContextManifest Evidence、Runtime Input Delivery Evidence 或 Formatter/Manifest/Profile 版本边界 | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)建立独立说明并取得二次确认，再读[Context 当前规范](architecture/foundational-invariants.md#context-session-bootstrap)、[ContextManifest v30](contracts/context-manifest-evidence-v30.md)、[Run Facts v7](contracts/run-facts-v7.md)及当前版本实施计划 |
| 修改 AgentRun 局部停止入口、直接提交、权威停止状态，实际模型观测、命令/搜索详情、Tool 聚合、持久化输出预算、Runtime Compaction 本地展示、运行中 Runtime diagnostic、首值冻结、默认策略回退、执行台位置偏好、进入恢复或模型展示 | [Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)、[产品/执行表面不变量](architecture/foundational-invariants.md#product-execution-surface)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)、[Run Process Detail Surface v42](contracts/run-process-detail-surface-v42.md)、[Camp Open Projection v23](contracts/camp-open-projection-v23.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Runtime-reported 文件操作、阅读操作、Command Diff、AgentRun 文件变化卡片、managed output 排除、归约/读取授权或文件变化呈现 | [Runtime File Change Observation v6](contracts/runtime-file-change-observation-v6.md)、[Runtime File Change Observation 架构](architecture/runtime-file-change-observation.md)、[Evidence/Activity 不变量](architecture/foundational-invariants.md#evidence-canonical-activity)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[v1.64 实施计划](versions/v1.64/implementation-plan.md) |
| 修改 Camp 文件预览、Files Changed 预览路由、执行过程文件入口、消息文件链接、路径呈现或解析基准、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v19](contracts/file-preview-v19.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.64 交付范围](versions/v1.64/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
| 修改 `MEMBER_IDENTITY`、`COLLABORATION_STATE`、peer 选择、Lead 引用、projection digest/inclusion 或 accepted ACK 水位 | [成员投影不变量](architecture/foundational-invariants.md#member-projection)、[Collaboration State v3](contracts/collaboration-state-v3.md)及[Built-in Tool Runtime 架构](architecture/builtin-tool-runtime.md) |
...
| 修改上下文 Gate、内置 Skill 回归、每周任务评测、每日 Trace 导出／统计／分析 | [双轨评测流程](development/evaluation.md)、[Execution Evaluation v15](contracts/execution-evaluation-v15.md)、[User Automation v6](contracts/user-automation-v6.md)与[双轨架构](architecture/execution-evaluation.md) |
| 修改 Benchmark 协议、Judge View、Tool-use/协作测量、Team/Solo paired experiment、Profile、比较资格、失败分类或 Project Review 投影 | [Benchmark 与 Judge 不变量](architecture/foundational-invariants.md#qualification-benchmark)、[Benchmark Protocol v3](contracts/benchmark-protocol-v3.md)、[Semantic Judge Views v12](contracts/semantic-judge-views-v12.md)、[Tool Interaction Measurement v2](contracts/tool-interaction-measurement-v2.md)、[Paired Collaboration Experiment v1](contracts/paired-collaboration-experiment-v1.md)及[Benchmark Protocol 架构](architecture/benchmark-protocol.md) |
...
| 修改取消、Runtime 清理、Input 发送边界或半取消恢复 | [Cancellation Settlement v2](contracts/cancellation-settlement-v2.md)、[Runtime 恢复与关闭](architecture/foundational-invariants.md#runtime-recovery-shutdown)，再读对应 Input、成员、渠道或退出合同 |
| 修改运行中网络中断分类、固定退避、online/resume wake、Core 重启、accepted Runtime input、Session/Turn 恢复、失败后隔离门禁或精确 Run Stop | [AgentRun Recovery 架构](architecture/agent-run-recovery.md)、[Runtime 恢复与关闭不变量](architecture/foundational-invariants.md#runtime-recovery-shutdown)、[Network Interruption Recovery v2](contracts/network-interruption-recovery-v2.md)及[Accepted Input Recovery v6](contracts/accepted-input-recovery-v6.md) |
| 修改主动退出/重启/更新、Core drain、launch/terminal admission、Runtime planned stop、durable shutdown fence、shutdown deadline 或 Desktop child-exit wait | [Camp Composer Draft v15](contracts/camp-composer-draft-v15.md)、[Planned Shutdown 架构](architecture/planned-shutdown.md)、[Runtime 恢复与关闭不变量](architecture/foundational-invariants.md#runtime-recovery-shutdown)及[Planned Shutdown v8](contracts/planned-shutdown-v8.md)；public Composer 不再有 Core Draft fence |
...
消息选文引用变更：先读[已确认上下文说明](versions/v1.56/model-context-change-partial-message-quotes.md)、[Message Quotes v1](contracts/message-quotes-v1.md)与[架构](architecture/message-quotes.md)，再读 Composer/Pending/Single Chat 及会话 UI 合同。
