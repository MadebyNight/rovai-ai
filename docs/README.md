...
| 任务 | 必读资料 |
|---|---|
| 修改 Mission、使命工作区、累计 Git Diff、使命上下文或桌面使命板 | [使命架构](architecture/missions.md)、[Mission v11](contracts/mission-v11.md)、[ContextManifest v28](contracts/context-manifest-evidence-v28.md)及[使命板 UI](ui/components/mission-board.md) |
...
| 修改 waiting Delivery、目标 Conversation 路由、FIFO batch claim、多输入 AgentRun、input budget、accepted 增量窗口或投递 Profile | [Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md)、[Message Delivery v10](contracts/message-delivery-v10.md)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v8](contracts/context-delivery-profile-v8.md)及[ContextManifest v28](contracts/context-manifest-evidence-v28.md) |
| 修改 Native Session Bootstrap、AgentRun Dynamic Context、`RUN_INPUT`、增量公共窗口、模型可见字段/JSON、遗漏、ContextManifest Evidence、Runtime Input Delivery Evidence 或 Formatter/Manifest/Profile 版本边界 | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)建立独立说明并取得二次确认，再读[Context 当前规范](architecture/foundational-invariants.md#context-session-bootstrap)、[ContextManifest v28](contracts/context-manifest-evidence-v28.md)、[Run Facts v6](contracts/run-facts-v6.md)及当前版本实施计划 |
