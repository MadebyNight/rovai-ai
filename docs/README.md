...
| 任务 | 必读资料 |
|---|---|
| 修改 Mission、使命工作区、累计 Git Diff、使命上下文或桌面使命板 | [使命架构](architecture/missions.md)、[Mission v4](contracts/mission-v4.md)、[ContextManifest v26](contracts/context-manifest-evidence-v26.md)及[使命板 UI](ui/components/mission-board.md) |
...
| 修改 public Camp 输入框、发送失败保留、撤回、附件 source refs 或 Desktop-local 编辑状态 | [Camp Composer Draft v15](contracts/camp-composer-draft-v15.md)、[Public Camp Composer 架构](architecture/camp-composer-draft.md)、[Camp Message Send v22](contracts/camp-message-send-v22.md)、[结构化 Mention 与 Atom](ui/components/structured-mentions.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改内置 Agent CLI、IPC、Envelope、receipt、完整结果运输、Single Chat history、定时 Automation、Mission、队员创建、Agent Send 或幂等合同 | [Built-in Tool Transport v28](contracts/builtin-tool-transport-v28.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v22](contracts/camp-message-send-v22.md)及[Current User Attention v6](contracts/current-user-attention-v6.md) |
...
| 修改 waiting Delivery、目标 Conversation 路由、FIFO batch claim、多输入 AgentRun、input budget、accepted 增量窗口或投递 Profile | [Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md)、[Message Delivery v10](contracts/message-delivery-v10.md)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v7](contracts/context-delivery-profile-v7.md)及[ContextManifest v26](contracts/context-manifest-evidence-v26.md) |
