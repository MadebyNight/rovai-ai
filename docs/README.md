...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、Single Chat history、定时 Automation、队员创建、纯附件 Agent Send 或幂等合同 | [Built-in Tool Transport v25 合同](contracts/builtin-tool-transport-v25.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Gather v5](contracts/gather-v5.md)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v20](contracts/camp-message-send-v20.md)及[Current User Attention v5](contracts/current-user-attention-v5.md) |
