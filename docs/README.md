...
| 任务 | 必读资料 |
|---|---|
| 修改 Mission、使命工作区、累计 Git Diff、使命上下文或桌面使命板 | [使命架构](architecture/missions.md)、[Mission v9](contracts/mission-v9.md)、[ContextManifest v27](contracts/context-manifest-evidence-v27.md)及[使命板 UI](ui/components/mission-board.md) |
...
| 修改 Camp 内单聊、私有 Conversation、Single Chat Context/Built-in policy、私有 terminal 路由、结束/取消、Conversation 级待发送队列或单聊 UI | [Single Chat v6](contracts/single-chat-v6.md)、[Single Chat Architecture](architecture/single-chat.md)、[Camp Attachment v10](contracts/camp-attachment-v10.md)、[Camp 会话工作区](ui/components/conversation-workspace.md#camp-内单聊) |
...
| 修改内置 Agent CLI、IPC、Envelope、receipt、完整结果运输、Single Chat history、定时 Automation、Mission、队员创建、Agent Send 或幂等合同 | [Built-in Tool Transport v30](contracts/builtin-tool-transport-v30.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v23](contracts/camp-message-send-v23.md)及[Current User Attention v6](contracts/current-user-attention-v6.md) |
...
| 修改 Camp 文件预览、Files Changed 预览路由、执行过程文件入口、消息文件链接、路径呈现或解析基准、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v17](contracts/file-preview-v17.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.55 交付范围](versions/v1.55/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
