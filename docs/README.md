...
| 修改 public Camp 输入框、发送失败保留、撤回、附件 source refs 或 Desktop-local 编辑状态 | [Camp Composer Draft v15](contracts/camp-composer-draft-v15.md)、[Public Camp Composer 架构](architecture/camp-composer-draft.md)、[Camp Message Send v24](contracts/camp-message-send-v24.md)、[结构化 Mention 与 Atom](ui/components/structured-mentions.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
