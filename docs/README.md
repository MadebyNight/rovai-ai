...
| 任务 | 必读资料 |
|---|---|
| 修改 Mission、使命工作区、累计 Git Diff、使命上下文或桌面使命板 | [使命架构](architecture/missions.md)、[Mission v3](contracts/mission-v3.md)、[ContextManifest v25](contracts/context-manifest-evidence-v25.md)及[使命板 UI](ui/components/mission-board.md) |
...
| 修改 Camp 成员 Fast、原生订阅资格、三态偏好、绑定代次或单次执行档位 | [Camp Member Fast v1](contracts/camp-member-fast-v1.md)、[Runtime Launch v41](contracts/runtime-launch-and-verification-v41.md)、[Usage v4](contracts/runtime-usage-monitoring-v4.md)、[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 public Camp 输入框、发送失败保留、撤回、附件 source refs 或 Renderer-local 编辑状态 | [Camp Composer Draft v14](contracts/camp-composer-draft-v14.md)、[Public Camp Composer 架构](architecture/camp-composer-draft.md)、[Camp Message Send v21](contracts/camp-message-send-v21.md)、[结构化 Mention 与 Atom](ui/components/structured-mentions.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Camp 内单聊、私有 Conversation、Single Chat Context/Built-in policy、私有 terminal 路由、结束/取消、Conversation 级待发送队列或单聊 UI | [Single Chat v5](contracts/single-chat-v5.md)、[Single Chat Architecture](architecture/single-chat.md)、[Camp Attachment v10](contracts/camp-attachment-v10.md)、[Camp 会话工作区](ui/components/conversation-workspace.md#camp-内单聊) |
...
| 修改内置 Agent CLI、IPC、Envelope、receipt、完整结果运输、Single Chat history、定时 Automation、Mission、队员创建、Agent Send 或幂等合同 | [Built-in Tool Transport v27](contracts/builtin-tool-transport-v27.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v21](contracts/camp-message-send-v21.md)及[Current User Attention v5](contracts/current-user-attention-v5.md) |
...
| 修改 `camp.search`、`camp.read`、`history.search`、实时可见性、recipient suppression、撤回过滤、Camp message publication fence 或 Agent read 附件输出 | [Camp History v7](contracts/camp-history-v7.md)、[公共上下文不变量](architecture/foundational-invariants.md#context-public-history)、[History 与寻址不变量](architecture/foundational-invariants.md#collaboration-history-addressing)、[Message Delivery 不变量](architecture/foundational-invariants.md#collaboration-delivery)、[Built-in Tool Runtime](architecture/builtin-tool-runtime.md)及[Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md) |
...
| 修改通知来源、Episode 聚合、未读/清除、会话可见确认、增量、浮层设置或类型化导航 | [Notification Episode v6](contracts/notification-episode-v6.md)、[Current User Attention v5](contracts/current-user-attention-v5.md)、[通知事实与投影](architecture/foundational-invariants.md#core-notifications)及[Notification Episode 架构](architecture/notification-episodes.md) |
...
| 修改 Camp 永久删除、强制删除、quiescence blocker、删除后的 Runtime 收敛或受管资源清理 | [Camp Permanent Deletion v3](contracts/camp-permanent-deletion-v3.md)、[Camp Published Attachment View](architecture/camp-published-attachment-view.md)、[Camp 资源不变量](architecture/foundational-invariants.md#camp-resources)、[协作与执行准入不变量](architecture/foundational-invariants.md#collaboration-admission)、[Runtime 恢复与关闭不变量](architecture/foundational-invariants.md#runtime-recovery-shutdown)及[Runtime 进程与校验不变量](architecture/foundational-invariants.md#runtime-process-verification) |
| 修改首次安装判断、新手训练页、无 Runtime 延后配置、断点恢复、首次队员/Runtime provisioning、`初次集结` 或 starter 输入行为 | [First-run Onboarding v4](contracts/first-run-onboarding-v4.md)、[First-run Onboarding 架构](architecture/first-run-onboarding.md)、[Availability-first Runtime](architecture/availability-first-runtime.md)、[首次训练 UI](ui/components/first-run-onboarding.md)、[Camp 生命周期不变量](architecture/foundational-invariants.md#camp-lifecycle)、[Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)及[Camp Composer Draft v14](contracts/camp-composer-draft-v14.md) |
...
| 修改 waiting Delivery、FIFO batch claim、多输入 AgentRun、input budget、accepted 增量窗口或投递 Profile | [Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md)、[Message Delivery v9](contracts/message-delivery-v9.md)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v7](contracts/context-delivery-profile-v7.md)及[ContextManifest v26](contracts/context-manifest-evidence-v26.md) |
| 修改 Native Session Bootstrap、AgentRun Dynamic Context、`RUN_INPUT`、增量公共窗口、模型可见字段/JSON、遗漏、ContextManifest Evidence、Runtime Input Delivery Evidence 或 Formatter/Manifest/Profile 版本边界 | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)建立独立说明并取得二次确认，再读[Context 当前规范](architecture/foundational-invariants.md#context-session-bootstrap)、[ContextManifest v26](contracts/context-manifest-evidence-v26.md)、[Run Facts v5](contracts/run-facts-v5.md)及当前版本实施计划 |
| 修改 AgentRun 局部停止入口、直接提交、权威停止状态，实际模型观测、命令/搜索详情、Tool 聚合、Runtime Compaction 本地展示、运行中 Runtime diagnostic、首值冻结、默认策略回退、执行台位置偏好、进入恢复或模型展示 | [Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)、[产品/执行表面不变量](architecture/foundational-invariants.md#product-execution-surface)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)、[Run Process Detail Surface v34](contracts/run-process-detail-surface-v34.md)、[Camp Open Projection v19](contracts/camp-open-projection-v19.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
| 修改 Runtime-reported 文件操作、阅读操作、Command Diff、AgentRun 文件变化卡片、managed output 排除、归约/读取授权或文件变化呈现 | [Runtime File Change Observation v5](contracts/runtime-file-change-observation-v5.md)、[Runtime File Change Observation 架构](architecture/runtime-file-change-observation.md)、[Evidence/Activity 不变量](architecture/foundational-invariants.md#evidence-canonical-activity)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[v1.57 实施计划](versions/v1.57/implementation-plan.md) |
| 修改 Camp 文件预览、Files Changed 预览路由、执行过程文件入口、消息文件链接、路径呈现或解析基准、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v16](contracts/file-preview-v16.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.55 交付范围](versions/v1.55/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
...
| 修改主动退出/重启/更新、Core drain、launch/terminal admission、Runtime planned stop、durable shutdown fence、shutdown deadline 或 Desktop child-exit wait | [Camp Composer Draft v14](contracts/camp-composer-draft-v14.md)、[Planned Shutdown 架构](architecture/planned-shutdown.md)、[Runtime 恢复与关闭不变量](architecture/foundational-invariants.md#runtime-recovery-shutdown)及[Planned Shutdown v7](contracts/planned-shutdown-v7.md)；public Composer 不再有持久 Draft fence |
