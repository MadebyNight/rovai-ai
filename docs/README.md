...
| 任务 | 必读资料 |
|---|---|
| 修改 Mission、使命工作区、累计 Git Diff、使命上下文或桌面使命板 | [使命架构](architecture/missions.md)、[Mission v11](contracts/mission-v11.md)、[ContextManifest v29](contracts/context-manifest-evidence-v29.md)及[使命板 UI](ui/components/mission-board.md) |
...
| 修改 Composer Skill Picker 的结构化身份、claim-time 批次资格、`RUN_INPUT.messages[].skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Run Input Skill Links v2](contracts/current-input-skill-links-v2.md)、[ContextManifest Evidence v29](contracts/context-manifest-evidence-v29.md)、[Structured Run Input Skill Links 架构](architecture/structured-current-input-skill-links.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 waiting Delivery、目标 Conversation 路由、FIFO batch claim、多输入 AgentRun、input budget、accepted 增量窗口或投递 Profile | [Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md)、[Message Delivery v10](contracts/message-delivery-v10.md)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v9](contracts/context-delivery-profile-v9.md)及[ContextManifest v29](contracts/context-manifest-evidence-v29.md) |
| 修改 Native Session Bootstrap、AgentRun Dynamic Context、`RUN_INPUT`、增量公共窗口、模型可见字段/JSON、遗漏、ContextManifest Evidence、Runtime Input Delivery Evidence 或 Formatter/Manifest/Profile 版本边界 | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)建立独立说明并取得二次确认，再读[Context 当前规范](architecture/foundational-invariants.md#context-session-bootstrap)、[ContextManifest v29](contracts/context-manifest-evidence-v29.md)、[Run Facts v7](contracts/run-facts-v7.md)及当前版本实施计划 |
