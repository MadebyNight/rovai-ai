...
| 任务 | 必读资料 |
|---|---|
| 修改 Mission、使命工作区、累计 Git Diff、使命上下文或桌面使命板 | [使命架构](architecture/missions.md)、[Mission v1](contracts/mission-v1.md)、[ContextManifest v24](contracts/context-manifest-evidence-v24.md)及[使命板 UI](ui/components/mission-board.md) |
...
| 修改内置 Agent CLI、IPC、Envelope、receipt、Projection、Gather、Single Chat history、定时 Automation、队员创建、纯附件 Agent Send 或幂等合同 | [Built-in Tool Transport v25 合同](contracts/builtin-tool-transport-v25.md)、[Built-in 运输不变量](architecture/foundational-invariants.md#skills-builtin-transport)、[Gather v5](contracts/gather-v5.md)、[Skill Library 与投影不变量](architecture/foundational-invariants.md#skills-library-projection)、[Camp Message Send v19](contracts/camp-message-send-v19.md)及[Current User Attention v5](contracts/current-user-attention-v5.md) |
| 修改普通用户 `rovai app`、Workspace inspection、Camp/Run 终端自动化、Diagnostic Trial、双 cursor 或诊断 bundle | [User Automation v5](contracts/user-automation-v5.md)、[User Automation Architecture](architecture/user-automation.md)、[Workspace 与动态 Git 不变量](architecture/foundational-invariants.md#camp-workspace)及[当前版本](versions/v1.54/README.md) |
| 修改 Desktop 定时任务、Automation 定义/快照、schedule、missed/overlap、恢复、结果冻结、Owner 通知或 Automation 工作区 | [Scheduled Automation v1](contracts/scheduled-automation-v1.md)、[Scheduled Automation Architecture](architecture/scheduled-automation.md)、[Scheduled Automation 不变量](architecture/foundational-invariants.md#scheduled-automation)及[Automation 工作区](ui/components/automation-workspace.md) |
| 修改 `camp.search`、`camp.read`、`history.search`、Agent/Human Principal message projection、跨 Camp Manifest/live authorization、Public A2A 历史可见性、Camp message publication fence 或 Agent read 附件输出 | [Camp History Retrieval v5](contracts/camp-history-v5.md)、[公共上下文不变量](architecture/foundational-invariants.md#context-public-history)、[History 与寻址不变量](architecture/foundational-invariants.md#collaboration-history-addressing)、[Message Delivery 不变量](architecture/foundational-invariants.md#collaboration-delivery)、[Built-in Tool Runtime](architecture/builtin-tool-runtime.md)及[Public A2A Message Delivery](architecture/public-a2a-message-delivery.md) |
...
| 修改 Desktop 用户 source attachment、Agent Managed v2、legacy Draft/Published 授权、Composer/Pending/Agent ingress、Timeline 系统打开、按动作 availability、Runtime resolver/root 或模型附件路径 | [Camp Attachment v9](contracts/camp-attachment-v9.md)、[Camp Published Attachment View v4（legacy）](contracts/camp-published-attachment-view-v4.md)、[Camp Attachments 架构](architecture/camp-published-attachment-view.md)、[ContextManifest Evidence v24](contracts/context-manifest-evidence-v24.md)、[Camp History Retrieval v5](contracts/camp-history-v5.md)、[Camp Identity v1](contracts/camp-identity-v1.md)、[Camp 资源不变量](architecture/foundational-invariants.md#camp-resources)、[Camp 会话工作区](ui/components/conversation-workspace.md)及[会话区拖放 UI](ui/components/conversation-drop-zone.md) |
| 修改用户消息回复、接收者延续、Composer Text + Atom/Typeahead/Clipboard、Draft 同步、离开 Camp 导航、App 退出前保存、纯附件/排队附件发送、失效换人或 Draft-only user send | [Composer Draft 不变量](architecture/foundational-invariants.md#camp-composer)、[Camp Composer Draft v13](contracts/camp-composer-draft-v13.md)、[Pending Camp Input v4](contracts/pending-camp-input-v4.md)、[Camp Composer Draft 架构](architecture/camp-composer-draft.md)、[结构化 Mention 与 Atom](ui/components/structured-mentions.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 Composer Skill Picker 的结构化身份、发送时资格、`CURRENT_INPUT.skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Current Input Skill Links v1](contracts/current-input-skill-links-v1.md)、[ContextManifest Evidence v24](contracts/context-manifest-evidence-v24.md)、[Structured Current Input Skill Links 架构](architecture/structured-current-input-skill-links.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 Gather Barrier、return capture、Completion Delivery/Run、legacy Attachment projection gate、membership lifetime、AgentRun 公共消息/Task 选择、正文/历史预算、引用链或投递 Profile | [持久 Gather Barrier](architecture/durable-gather-barrier.md)、[Gather v5](contracts/gather-v5.md)、[Gather 不变量](architecture/foundational-invariants.md#collaboration-gather)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v6](contracts/context-delivery-profile-v6.md)及[Message Delivery v8](contracts/message-delivery-v8.md) |
...
| 修改 Camp 文件预览、Files Changed 预览路由、执行过程文件入口、消息文件链接、路径呈现或解析基准、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v13](contracts/file-preview-v13.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.55 交付范围](versions/v1.55/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
...
| 修改上下文 Gate、内置 Skill 回归、每周任务评测、每日 Trace 导出／统计／分析 | [双轨评测流程](development/evaluation.md)、[Execution Evaluation v14](contracts/execution-evaluation-v14.md)、[User Automation v5](contracts/user-automation-v5.md)与[双轨架构](architecture/execution-evaluation.md) |
...
| 修改运行中网络中断分类、固定退避、online/resume wake、Core 重启、accepted Runtime input、Session/Turn 恢复、`recovery_blocked`、Stop/预算收敛或旧 Turn reattach | [AgentRun Recovery 架构](architecture/agent-run-recovery.md)、[Runtime 恢复与关闭不变量](architecture/foundational-invariants.md#runtime-recovery-shutdown)、[Network Interruption Recovery v1](contracts/network-interruption-recovery-v1.md)及[Accepted Input Recovery v5](contracts/accepted-input-recovery-v5.md) |
| 修改主动退出/重启/更新、退出前 Composer Draft fence、Core drain、launch/terminal admission、Runtime planned stop、durable shutdown fence、shutdown deadline 或 Desktop child-exit wait | [Camp Composer Draft v13](contracts/camp-composer-draft-v13.md)、[Planned Shutdown 架构](architecture/planned-shutdown.md)、[Runtime 恢复与关闭不变量](architecture/foundational-invariants.md#runtime-recovery-shutdown)及[Planned Shutdown v6](contracts/planned-shutdown-v6.md) |
