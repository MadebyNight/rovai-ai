...
| 修改 Camp 成员 Fast、原生订阅资格、三态偏好、绑定代次或单次执行档位 | [Camp Member Fast v1](contracts/camp-member-fast-v1.md)、[Runtime Launch v43](contracts/runtime-launch-and-verification-v43.md)、[Usage v4](contracts/runtime-usage-monitoring-v4.md)、[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改当前 Skills 受管文件、队员工具箱、Harness 原生发现、旧项目投影清理或设置页 | [Skills 架构](architecture/skills.md)、[Skills Rebuild v2](contracts/skills-rebuild-v2.md)、[Skills UI](ui/components/skills-settings.md)及[Runtime 进程与校验不变量](architecture/foundational-invariants.md#runtime-process-verification)；旧 Revision/投影恢复再读[历史 Skill Projection](architecture/skill-projection-reconciliation.md) |
| 修改 Composer Skill Picker 的结构化身份、claim-time 批次资格、`RUN_INPUT.messages[].skills` 文件链接或对应 Manifest Evidence | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)确认 revision，再读[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Skills Rebuild v2](contracts/skills-rebuild-v2.md)、[Run Input Skill Links v2](contracts/current-input-skill-links-v2.md)、[ContextManifest Evidence v31](contracts/context-manifest-evidence-v31.md)、[Skills 架构](architecture/skills.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 waiting Delivery、目标 Conversation 路由、FIFO batch claim、多输入 AgentRun、input budget、accepted 增量窗口或投递 Profile | [Public Camp Message/Delivery 架构](architecture/public-a2a-message-delivery.md)、[Message Delivery v10](contracts/message-delivery-v10.md)、[ContextManifest 与 Run Facts 不变量](architecture/foundational-invariants.md#context-manifest-run-facts)、[Context Delivery Profile v10](contracts/context-delivery-profile-v10.md)及[ContextManifest v31](contracts/context-manifest-evidence-v31.md) |
| 修改 Native Session Bootstrap、AgentRun Dynamic Context、`RUN_INPUT`、增量公共窗口、模型可见字段/JSON、遗漏、ContextManifest Evidence、Runtime Input Delivery Evidence 或 Formatter/Manifest/Profile 版本边界 | 先按[核心模型上下文变更治理](development/model-context-change-governance.md)建立独立说明并取得二次确认，再读[Context 当前规范](architecture/foundational-invariants.md#context-session-bootstrap)、[ContextManifest v31](contracts/context-manifest-evidence-v31.md)、[Run Facts v8](contracts/run-facts-v8.md)及当前版本实施计划 |
| 修改 AgentRun 局部停止入口、直接提交、权威停止状态，实际模型观测、命令/搜索详情、Tool 聚合、持久化输出预算、Runtime Compaction 本地展示、运行中 Runtime diagnostic、首值冻结、默认策略回退、执行台位置偏好、进入恢复或模型展示 | [Runtime Catalog 与 Installation 不变量](architecture/foundational-invariants.md#runtime-catalog-installation)、[产品/执行表面不变量](architecture/foundational-invariants.md#product-execution-surface)、[Runtime Catalog Boundaries](architecture/runtime-catalog-boundaries.md)、[Run Process Detail Surface v42](contracts/run-process-detail-surface-v42.md)、[Camp Open Projection v24](contracts/camp-open-projection-v24.md)及[Camp 会话工作区](ui/components/conversation-workspace.md) |
...
| 修改 Camp 文件预览、Files Changed 预览路由、执行过程文件入口、消息文件链接、路径呈现或解析基准、窗口内 Tab 恢复、项目内子文件独立恢复、owner-scoped 附件打开、具体文件能力、预览句柄/分页/Root Grant、HTML 沙箱、root watcher、文件 Tabs 或刷新 | [File Preview v20](contracts/file-preview-v20.md)、[File Preview Architecture](architecture/file-preview.md)、[Camp 文件预览区](ui/components/file-preview.md)、[Camp 会话工作区](ui/components/conversation-workspace.md)、[v1.64 交付范围](versions/v1.64/README.md)及[v1.30 初始实施](versions/v1.30/implementation-plan.md) |
...
| 修改诊断自检、单项修复、三态分类、Recovery 或 v5 导出/脱敏 | [Runtime 平台安全不变量](architecture/foundational-invariants.md#runtime-platform-security)、[Diagnostics Center v2](contracts/diagnostics-center-v2.md)及[诊断中心架构](architecture/diagnostics-center.md) |
