...
function Fixture(): React.JSX.Element {
  ...
  return <div id="preview-fixture" style={{ height: '100vh', width: '100vw', display: 'flex', flexDirection: 'column' }}><style>{'#file-preview-pane{width:100%;min-height:0;flex:1}'}</style><FilePreviewTabs /><FilePreviewPane /></div>
}
