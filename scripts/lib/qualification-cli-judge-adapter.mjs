...
import { SUBSTANTIATION_CLAIM_AUDIT_PROFILE, SUBSTANTIATION_CLAIM_AUDIT_INSTRUCTION, HISTORY_CLAIM_AUDIT_PROFILE, HISTORY_CLAIM_AUDIT_INSTRUCTION, SOURCE_CLAIM_AUDIT_INSTRUCTION, EXECUTION_CLAIM_AUDIT_PROFILE, EXECUTION_CLAIM_AUDIT_INSTRUCTION, DELIVERY_CLAIM_AUDIT_PROFILE, DELIVERY_CLAIM_AUDIT_INSTRUCTION, WITNESS_CLAIM_AUDIT_PROFILE, WITNESS_CLAIM_AUDIT_INSTRUCTION, CLAIM_AUDIT_PROFILE, CLAIM_AUDIT_INSTRUCTION, claimAuditSchema, applyClaimAudit } from './qualification-claim-audit.mjs'
...
export const claimAuditProfiles = [CLAIM_AUDIT_PROFILE, WITNESS_CLAIM_AUDIT_PROFILE, DELIVERY_CLAIM_AUDIT_PROFILE, EXECUTION_CLAIM_AUDIT_PROFILE, HISTORY_CLAIM_AUDIT_PROFILE, SUBSTANTIATION_CLAIM_AUDIT_PROFILE]
